...
export default function StoryPage() {
      ...
      <main className="min-h-screen p-8" style={{ backgroundColor: '#1d1d1d' }}>
        <div className="max-w-7xl mx-auto">
          <div className="text-center text-gray-500 py-20">
            ...
            <Link href="/stories" className="text-blue-400 hover:text-blue-300">
              Back to stories
            </Link>
          </div>
        </div>
  ...
  return (
    <main className="min-h-screen p-8" style={{ backgroundColor: '#1d1d1d' }}>
      <div className="max-w-7xl mx-auto">
        <Link href="/stories" className="text-gray-400 hover:text-white mb-6 inline-block">
          ← Back to stories
        </Link>
              ...
              <div className="space-y-3 mt-6">
                ...
                {story.tokensUsed && (
                  <div className="flex justify-between text-sm">
                    ...
                    <span className="text-white">{story.tokensUsed}</span>
                  </div>
                )}
